...
path_1 = "/remote/gpu07/huetsch/GenerativeJetting/runs/Conditional/1j/BayesMT/2b_5l_128d_32EncodeALL_1e3C_1k3481"
path_2 = "/remote/gpu07/huetsch/GenerativeJetting/runs/Conditional/j2/BayesMT/2b_5l_64d_32EncodeAll_1e3C_5k8739"
path_3 = "/remote/gpu07/huetsch/GenerativeJetting/runs/Conditional/j3/BayesMT/2b_5l_64d_32EncodeAll_1e3C_10k9515"
...
for i in range(1,4):
    ...
    if i < 3:
        ...
        plot_train_jets = globals()[f"experiment_{i}"].model.data_train[globals()[f"experiment_{i}"].model.data_train[:, 0] == i]
        plot_train_jets = plot_train_jets[:, 1:]

        plot_test_jets = globals()[f"experiment_{i}"].model.data_test[globals()[f"experiment_{i}"].model.data_test[:, 0] == i]
        ...
        plot_train_jets = (globals()[f"experiment_{i}"].model.data_train)
        plot_test_jets = (globals()[f"experiment_{i}"].model.data_test)
...
# Create the plot
with PdfPages(f"paper_plots_inclusive.pdf") as out:
    plot_paper(pp=out,
