...
class GPT(nn.Module):
    ...
    def forward(self, idx):
        ...
        tok_emb = self.transformer.wte(idx) # token embeddings of shape (b, t, intermediate_dim)
        pos_emb = self.transformer.wpe(pos) # position embeddings of shape (1, t, intermediate_dim)
