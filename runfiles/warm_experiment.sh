...
python run_Zn.py --warm_start_path="/remote/gpu07/huetsch/GenerativeJetting/runs/Conditional/j2/BayesMagicTrafo/8b_3l_128d_64EncodeAll_BlockOutTest_2Bays5059"
